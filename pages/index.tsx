...
const HomePage: NextPage = () => {
	return (
		<>
			...
			<FadeIn className='w-[80vw] md:w-[40vw] m-auto mb-16'>
				<h3 className='text-3xl font-semibold mb-7'>
					Международная форумы по торговле нефтью: Наш вклад в развитие отрасли
				</h3>
				<p className='mb-7'>
				...
				<p className='mb-7'>
					...
					газа стран СНГ проходили в двухдневном формате, включая доклады,
					семинары и симуляционные практические занятия с применением свопов,
					фьючерсов и инструментов хеджирования.
				</p>
				<p className='mb-7'>
					Основными задачами организации конференций и семинаров были:
				</p>
				<ul className='mb-7'>
